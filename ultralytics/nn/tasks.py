...
from ultralytics.nn.modules import (
    ...
    stem,
    C3CFBlockNet,
    BiLevelRoutingAttention,C2f_Faster,AVBlock,GSConv,SDI,Zoom_cat,ScalSeq,attention_model
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            PSA,
            SCDown,
            C2fCIB,C2f_Faster,AVBlock,GSConv
        }:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB,C2f_Faster,AVBlock):
            ...
            c2 = ch[f]
            args = [c2, *args[0:]]
        elif m is C3CFBlockNet:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # if not output
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]
            if m is C3CFBlockNet:
                args.insert(2, n)  # number of repeats
                n = 1
